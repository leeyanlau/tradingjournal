...
const dummyTrades: Trade[] = [
  {
    ...
    checklistScore: 4,
    suggestedRisk: '0%',
    remarks: 'Chased breakout, no confirmation',
    feeling: 'Anxious',
    movedStops: true,
  ...
  },
  {
    ...
    checklistScore: 5,
    suggestedRisk: '0%',
    remarks: 'Lucky reversal, no real setup',
    feeling: 'Calm',
    movedStops: false,
  ...
  },
  {
    ...
    checklistScore: 5,
    suggestedRisk: '0%',
    remarks: 'Entered mid-range, no structure',
    feeling: 'Anxious',
    movedStops: true,
    movedStopsWorked: 'OVERMANAGED',
  },
  {
    ...
    checklistScore: 6,
    suggestedRisk: '0.5%',
    remarks: 'First structured trade showing improvement',
    feeling: 'Calm',
    movedStops: true,
  ...
  },
  {
    ...
    checklistScore: 7,
    suggestedRisk: '0.5%',
    remarks: 'Started waiting for pullback + structure',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 7,
    suggestedRisk: '0.5%',
    remarks: 'Clean SMT + liquidity sweep',
    feeling: 'Calm',
    movedStops: false,
    movedStopsWorked: null,
  },
  {
    ...
    checklistScore: 6,
    suggestedRisk: '0.5%',
    remarks: 'FOMO entry after move already started',
    feeling: 'Anxious',
    movedStops: true,
    movedStopsWorked: 'OVERMANAGED',
  },
  {
    ...
    checklistScore: 8,
    suggestedRisk: '1%',
    remarks: 'Full confluence trade, clean execution',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 6,
    suggestedRisk: '0%',
    remarks: 'Counter-trend trade, no patience',
    feeling: 'Anxious',
    movedStops: true,
  ...
  },
  {
    ...
    checklistScore: 8,
    suggestedRisk: '1%',
    remarks: 'Patience + structure alignment improving',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 9,
    suggestedRisk: '1%',
    remarks: 'Textbook liquidity grab + reversal',
    feeling: 'Calm',
    movedStops: false,
    movedStopsWorked: null,
  },

  {
    ...
    checklistScore: 8,
    suggestedRisk: '1%',
    remarks: 'Clean continuation after liquidity sweep',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 9,
    suggestedRisk: '1%',
    remarks: 'Perfect SMT divergence entry',
    feeling: 'Calm',
    movedStops: false,
    movedStopsWorked: null,
  },
  {
    ...
    checklistScore: 8,
    suggestedRisk: '0.5%',
    remarks: 'Controlled breakout retrace entry',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 9,
    suggestedRisk: '1%',
    remarks: 'Trend continuation with strong structure alignment',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 8,
    suggestedRisk: '1%',
    remarks: 'Clean pullback into PD array resistance',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 8,
    suggestedRisk: '0.5%',
    remarks: 'Valid setup but early exit due to volatility spike',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'IRRELEVANT',
  },
  {
    ...
    checklistScore: 9,
    suggestedRisk: '1%',
    remarks: 'Perfect liquidity grab reversal',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 9,
    suggestedRisk: '1%',
    remarks: 'A+ setup, waited for confirmation candle',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
  {
    ...
    checklistScore: 9,
    suggestedRisk: '1%',
    remarks: 'SMT + liquidity sweep + clean execution',
    feeling: 'Calm',
    movedStops: false,
    movedStopsWorked: null,
  },
  {
    ...
    checklistScore: 9,
    suggestedRisk: '1%',
    remarks: 'High-confidence trend continuation trade',
    feeling: 'Calm',
    movedStops: true,
    movedStopsWorked: 'PROTECTED',
  },
